...
export default function WelcomePage() {
  ...
  // The first value is the value to be transformed, the second is a mapping an array of the scroll in this case, and the third is a list that the second value will be mapped,
  // so if the first value is zero, the opacityCity will be 1, and it will transform from 1 to 0.5 while the scrollY changes from 0 to 200.
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        <motion.img
          style={{opacity: opacityCity, y: yCity}} // style works the same as animation, but it changes when the value of the property changes, not when something in the screen changes, like animation does.
          src={cityImg}
